...
import '../pages/player/player_report_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // Organizer
        '/organizerHome': (_) => const MainNavigationPage(),
        ...
        '/player-profile': (context) {
          ...
          return ViewPlayerProfilePage(userId: userId);
        },
        ...
        '/player-report': (context) => const PlayerReportPage(),
