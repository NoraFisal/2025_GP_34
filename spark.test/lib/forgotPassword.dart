...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Widget build(BuildContext context) {
    const Color accentColor = Color(0xFF9E2819); // نفس لون الازرار في صفحة اللوق ان

    return Scaffold(
      body: Stack(
        children: [
          // الخلفية نفسها مثل صفحة تسجيل الدخول
          Image.asset(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // حقل الإيميل بنفس تنسيق صفحة اللوق ان
                          TextFormField(
                          ...
                          // زر الإرسال بنفس تصميم اللوق ان
                          _customButton(
...
Positioned(
  ...
  // نفس تصميم الزر من صفحة اللوق ان
